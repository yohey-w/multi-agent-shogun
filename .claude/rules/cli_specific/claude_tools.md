...
For Engineer: After `/clear`, follow CLAUDE.md /clear recovery procedure. Do NOT read .claude/rules/engineer.md for the first task (cost saving).
...
3. Read your instructions file (orchestrator→.claude/rules/orchestrator.md, planner→.claude/rules/planner.md, engineer→.claude/rules/engineer.md)
