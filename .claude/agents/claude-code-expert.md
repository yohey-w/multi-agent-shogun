...
## 主な情報源 (.claude/agents/claude-code-expert/agent-memory/claude-code-expert.md §12 より)
...
4. **本プロジェクト固有の判断**: `.claude/agents/claude-code-expert/agent-memory/claude-code-expert.md` に記録された過去の調査結果を参照し、再調査コストを節約する

## 重要な公式制約 (必ず遵守させる判断)

### subagent からの dispatch 禁止 (.claude/agents/claude-code-expert/agent-memory/claude-code-expert.md §2 §10.1)
公式仕様より:
...
## 作業開始前
1. `.claude/agents/claude-code-expert/agent-memory/claude-code-expert.md` を Read (このプロジェクトでの公式仕様調査結果)
2. `.claude/agents/claude-code-expert/agent-memory/MEMORY.md` を Read (index)
3. 質問に関連するセクションを特定する
...
## このプロジェクトでの記憶
`.claude/agents/claude-code-expert/agent-memory/claude-code-expert.md`
